import { Pill, Utensils, Activity, Calendar, Check, AlertTriangle } from 'lucide-react';
...
export function HomeScreen({ onNavigate }: HomeScreenProps) {
  ...
  const cards = [
    { icon: Pill, title: 'Medications', subtitle: '3 today', color: 'var(--primary-blue)', nav: 'medications' },
    { icon: Utensils, title: 'Diet Plan', subtitle: 'On track', color: 'var(--success-green)', nav: 'diet' },
    { icon: Activity, title: 'Activities', subtitle: 'View safe', color: 'var(--secondary-teal)', nav: 'activities' },
    { icon: Calendar, title: 'Appointments', subtitle: 'Next: Dec 2', color: 'var(--warning-yellow)', nav: 'appointments' },
  ];
            ...
            {tasks.map((task) => (
              ...
              >
                <div style={{
                  ...
                  height: '20px',
                  borderRadius: '6px',
                  border: task.completed ? 'none' : '2px solid var(--border-grey)',
                ...
                <p style={{
                  color: task.completed ? 'var(--muted-text)' : 'var(--dark-text)',
