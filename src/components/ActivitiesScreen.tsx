import { CheckCircle, XCircle, MessageSquare, Footprints, Dumbbell, Bike, Waves, Mountain, Zap } from 'lucide-react';
...
export function ActivitiesScreen({ onAskAI }: ActivitiesScreenProps) {
  ...
  const restrictedActivities = [
    ...
    { icon: Zap, name: 'High-intensity exercise', description: 'Running, HIIT' },
      ...
      <div style={{ padding: '16px' }}>
            ...
            {allowedActivities.map((activity, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h3 style={{ marginBottom: '4px', fontSize: '16px' }}>{activity.name}</h3>
        ...
        <div style={{
          ...
          <ul style={{ margin: 0, paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <li style={{ color: 'var(--dark-text)' }}>Start slowly and gradually increase activity</li>
            <li style={{ color: 'var(--dark-text)' }}>Stop if you experience pain or discomfort</li>
            <li style={{ color: 'var(--dark-text)' }}>Rest when needed and don't push yourself</li>
            <li style={{ color: 'var(--dark-text)' }}>Consult your doctor before starting new activities</li>
          </ul>
        </div>
      </div>
    </div>
