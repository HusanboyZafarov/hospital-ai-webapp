...
export function OnboardingScreen({ step, onNext, onComplete }: OnboardingScreenProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4" style={{ backgroundColor: 'var(--bg-white)' }}>
      <div className="flex flex-col items-center text-center max-w-sm">
        ...
        >
          <Icon size={64} style={{ color: 'var(--primary-blue)' }} strokeWidth={1.5} />
        </div>
          ...
          {screens.map((_, index) => (
            <div
              ...
              style={{
                ...
                height: '8px',
                borderRadius: '4px',
                backgroundColor: index === step ? 'var(--primary-blue)' : 'var(--border-grey)',
