...
export function MedicationScheduleScreen({ onBack }: MedicationScheduleScreenProps) {
  const schedule = [
    {
      day: 'Today - Nov 28',
      medications: [
        { period: 'Morning', icon: Sunrise, meds: ['Amoxicillin 500mg - 8:00 AM', 'Vitamin D 1000 IU - 8:00 AM'] },
        { period: 'Afternoon', icon: Sun, meds: ['Ibuprofen 400mg - 2:00 PM'] },
        { period: 'Evening', icon: Moon, meds: ['Amoxicillin 500mg - 8:00 PM'] },
      ]
    },
    {
      day: 'Tomorrow - Nov 29',
